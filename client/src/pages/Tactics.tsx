...
const tactics = [
  ...
  },
  {
    ...
    tag: "Conversion",
    tagColor: "bg-purple-100 text-purple-700",
    title: "7 Strategies That Turn Junk Removal Leads Into Booked Jobs",
    summary:
    ...
    tips: [
      "Respond within 5 minutes or you've already lost. Speed is the single biggest conversion lever in local service businesses. Studies consistently show that leads contacted within 5 minutes are 9× more likely to convert than leads contacted after 30 minutes. The prospect who called you also called two other companies. The first one to respond with a real answer and a real price wins the job — almost every time. This is not about being pushy. It's about being present. If you can't answer every call live, you need an automated response system that fires a personalized text within minutes of every missed call, form submission, or Facebook message. LeadHauler's Speed-to-Lead tool does this automatically so no lead goes cold while you're on a job.",
      "Give a price range on the first call — never say 'I have to see it first.' The fastest way to lose a lead is to refuse to give any pricing information on the first contact. Prospects are calling multiple companies. The ones who give a clear, confident price range ('Based on what you're describing, most jobs like that run between $150 and $300') immediately stand out as professionals who know their business. You're not committing to a final price — you're giving them enough to make a decision to move forward. Operators who say 'I can't quote without seeing it' force the prospect to keep calling until someone else gives them a number. That someone else gets the job.",
      "Use a same-day or next-day close. Urgency is your friend. When a prospect calls, the window to convert them is open right now — not tomorrow. Offer a same-day or next-day appointment as your default: 'We actually have availability this afternoon — want me to lock that in for you?' This does two things: it creates a soft deadline that prevents the prospect from continuing to shop around, and it signals that you're an organized, in-demand operation. Most people who call for junk removal want it gone soon. Meeting that desire immediately is a conversion tactic, not a pressure tactic.",
      "Follow up three times before you give up. Most operators follow up once — if at all. The data on lead follow-up is clear: 80% of sales require at least 5 follow-up contacts, but 44% of salespeople give up after one. In junk removal, a three-touch follow-up sequence is enough to capture most of the leads you'd otherwise lose. Touch 1: a text or call within 5 minutes of the initial inquiry. Touch 2: a follow-up text 2–3 hours later if no response ('Hey [name], just wanted to make sure you got my message — we still have availability today'). Touch 3: a final follow-up the next morning ('Good morning — still happy to help with your cleanout whenever you're ready'). Three touches, 18 hours, and you've done more than 90% of your competitors.",
      "Anchor your price with a comparison. Price objections are almost always about perceived value, not actual budget. When a prospect says 'that seems expensive,' the answer is not to lower your price — it's to reframe what they're comparing it to. 'A 1-ton truck rental plus dump fees plus your time is going to run you $200–$300 and a full Saturday. We handle everything for $275 and you don't lift a finger.' Or: 'Most of our customers tell us they tried to do it themselves first and ended up calling us anyway after two weekends of not finishing.' Anchoring your price against the real cost of the alternative — time, truck rental, dump fees, physical effort — shifts the conversation from 'is this cheap?' to 'is this worth it?' The answer is almost always yes.",
      "Collect a soft commitment before you hang up. Every call should end with a specific next step, not a vague 'I'll think about it.' If the prospect isn't ready to book on the spot, get a micro-commitment: 'Can I send you a quick text with our pricing so you have it handy?' or 'Would it be okay if I followed up with you tomorrow morning?' A soft commitment keeps the door open and gives you a reason to follow up without feeling like you're pestering them. It also subtly shifts the dynamic — they've agreed to hear from you again, which means the next contact is expected, not intrusive.",
      "Ask for the review before you leave the job site. The best time to ask for a Google review is the moment the job is done and the customer is standing there looking at their clean space. They're happy. They're relieved. They're grateful. Pull up your Google Business Profile on your phone, hand it to them, and say: 'It would mean a lot to us if you left us a quick review — it only takes 30 seconds.' This single habit, done consistently on every job, compounds into a review profile that converts future leads before you even pick up the phone. A business with 80 five-star reviews converts at a dramatically higher rate than a business with 12 — even if the service is identical. Reviews are not a reputation tool. They are a conversion tool.",
    ],
    readTime: "6 min read",
