        ...
        <div className="container relative">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center pt-10 pb-16 sm:pt-14 sm:pb-24 lg:pt-16 lg:pb-32">
            ...
            <div className="hidden lg:flex flex-col pl-8" style={{ gap: 0 }}>
              {/* Mike image — flush to top, overlaps the card below */}
              ...
              <div ref={stat312.ref} className="relative rounded-2xl bg-primary px-8 pb-8 pt-32 text-primary-foreground shadow-2xl">
